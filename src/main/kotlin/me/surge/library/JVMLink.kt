...
import me.surge.lexer.value.JavaClassLinkValue
...
object JVMLink {
    ...
    fun classForName(functionData: FunctionData, path: StringValue, identifier: StringValue, arguments: ListValue) {
        ...
        functionData.context.parent?.parent?.symbolTable!!.set(identifier.value, JavaClassLinkValue(identifier.value, clazz, instance, constructors), SymbolTable.EntryData(immutable = true, declaration = true, functionData.start, functionData.end, functionData.context))
    }
